...
plugin_info_t Plugin_info = {
	META_INTERFACE_VERSION,"Ticket's dumper","0.2.0","27/05/17","shel","http://pvpru.com/","SteamTicketsDumper",PT_CHANGELEVEL,PT_ANYTIME
};
...
C_DLLEXPORT int Meta_Attach(PLUG_LOADTIME now, META_FUNCTIONS *pFunctionTable, meta_globals_t *pMGlobals, gamedll_funcs_t *pGamedllFuncs)
{
	...
	if (!g_bReHLDS)return FALSE;
	
	if(!OnMetaAttach())return FALSE;
